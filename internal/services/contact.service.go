...
func FindMany(
	...
	// we have to close the cursor in the parent function although this will create an dependecy
	return cursor, nil
}

func InsertOne(ctx context.Context, collection *mongo.Collection, document any) (bson.ObjectID, error) {
...
func UpdateOne(ctx context.Context, collection *mongo.Collection, filter bson.M, update bson.M) (int64, error) {
